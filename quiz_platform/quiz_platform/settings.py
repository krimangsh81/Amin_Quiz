...
SECRET_KEY = 'django-insecure-#6yd5k4!aa5hy!boya2h6lm5go3b^vouf43pmv8k=c4vkl=&-p'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'core',  # Custom app for quiz platform
    'channels',  # For WebSocket support
    'frontend',  # Frontend app for quiz platform
]
...
# Redis setup (if you're using it for Channels layer)
CHANNEL_LAYERS = {
    "default": {
